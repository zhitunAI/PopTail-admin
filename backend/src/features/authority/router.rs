...
use super::{
    authority_btn_get, authority_btn_get_batch, authority_btn_set, authority_list, authority_set_role_users,
    authority_upsert, authority_users, menu_authority_get, menu_authority_set, menu_delete,
    menu_list, menu_roles_get, menu_roles_set, menu_tree, menu_upsert, menu_upsert_batch, user_list,
    user_policy_paths, user_policy_paths_set,
};
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/authorityBtn/getAuthorityBtns", post(authority_btn_get_batch))
        ...
        .route("/menu/saveMenus", post(menu_upsert_batch))
        .route("/menu/deleteBaseMenu", post(menu_delete))
