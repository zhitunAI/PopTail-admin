...
import type { AuthorityInfo, UserInfo } from '#/types/gin-ai-admin';
  ...
  <Page auto-content-height>
    <Grid table-title="用户列表">
      ...
      <template #operation="{ row }">
        <Space size="small">
          <Button size="small" type="link" @click="onEdit(row as UserRow)">
            编辑
          </Button>
          <Button danger size="small" type="link" @click="onDelete(row as UserRow)">
            删除
          </Button>
        </Space>
      </template>
