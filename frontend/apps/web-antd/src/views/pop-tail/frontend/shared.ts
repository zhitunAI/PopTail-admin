...
const STORAGE_KEYS = {
  articleCategories: 'pop-tail-frontend-article-categories',
  articles: 'pop-tail-frontend-articles',
  consoleMenus: 'pop-tail-frontend-console-menus',
  frontendNav: 'pop-tail-frontend-nav',
  members: 'pop-tail-frontend-members',
};
