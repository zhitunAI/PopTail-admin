...
<template>
  <Page auto-content-height>
    ...
    <div class="relative flex h-full min-h-0 flex-1 flex-col">
      <Grid class="h-full min-h-0 flex-1" table-title="角色列表">
      ...
      <template #id="{ row }">
        <PageRefreshCellSkeleton v-if="pageLoading" width="56%" />
      ...
      <template #operation="{ row }">
        <PageRefreshCellSkeleton v-if="pageLoading" width="130px" />
