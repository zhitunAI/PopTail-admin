...
export interface BootstrapResult {
  ...
  menus: MenuInfo[];
  authorityButtons: AuthorityButtonMatrixBatchSelectionItem[];
}
...
export interface AuthorityButtonMatrixBatchInput {
  authorityId: number;
  menuIDs: number[];
}

export interface AuthorityButtonMatrixBatchSelectionItem {
  menuID: number;
  selected: number[];
}
...
export interface EmailPresetRecord {
  ID: number;
  name: string;
  description: string;
  to: string;
